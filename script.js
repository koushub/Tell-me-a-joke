...
function tellJoke(joke){
    ...
    VoiceRSS.speech({
        key: '6317a3f7a0c64344ac28d3f0357a3442',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Programming,Dark,Pun?blacklistFlags=religious,political,racist,sexist';
    try {
        ...
        console.log('Oops, Looks like an error occured',error);
    }
}
